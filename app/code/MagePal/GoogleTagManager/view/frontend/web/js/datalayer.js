...
define([
    ...
    function updateDataLayer(_gtmDataLayer, _dataObject, _forceUpdate)
    {
        ...
        if (_gtmDataLayer !== undefined && (!objectKeyExist(_gtmDataLayer) || _forceUpdate)) {
            ...
            let test = '[ "ecommerce: {currencyCode: "USD", "add: {products: [{id: "EPC2SA","name: "Stronglite Ergo Pro II\u2122 Portable Massage Chair","price: 429","quantity: 1  }"]';
            _gtmDataLayer.push({'event': 'addToCart', 'ecommerce':"ll" });
        }
    }
