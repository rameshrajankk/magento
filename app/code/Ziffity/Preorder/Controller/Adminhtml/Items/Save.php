...
class Save extends \Ziffity\Preorder\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('ziffity/preorder');
                        ...
                        $imagePath = 'ziffity/preorder'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('ziffity_preorder/*/edit', ['id' => $model->getId()]);
                    return;
                }
                $this->_redirect('ziffity_preorder/*/');
                return;
            } catch (\Magento\Framework\Exception\LocalizedException $e) {
                $this->messageManager->addError($e->getMessage());
                $id = (int)$this->getRequest()->getParam('id');
                if (!empty($id)) {
                    $this->_redirect('ziffity_preorder/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('ziffity_preorder/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('ziffity_preorder/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('ziffity_preorder/*/');
